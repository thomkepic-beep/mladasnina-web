...
export default function JoinForm() {
  ...
  return (
    <form className="grid gap-4" onSubmit={handleSubmit}>
      ...
      <input name="email" type="email" value={formData.email} onChange={handleChange} className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:ring-2 focus:ring-[#1E2F6E]" placeholder="E-mail" required />
      ...
      <p className="text-xs text-slate-500">Tvoje údaje použijeme iba na kontaktovanie v súvislosti s prihláškou do MP Snina.</p>
