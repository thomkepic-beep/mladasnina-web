      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-xl text-lg leading-8 text-slate-300">
            Napíš nám, sleduj naše sociálne siete alebo sa zastav osobne. Radi sa ozveme späť.
          </p>
          ...
          <div className="mt-6 rounded-2xl bg-white/10 px-4 py-3 text-sm font-medium">✉ {contacts.email}</div>
          <div className="mt-4 inline-flex items-center gap-3 rounded-2xl bg-white/5 px-4 py-3 text-slate-200">
            <Send className="h-5 w-5 text-[#F1DE8B]" />
            <span>
              <span className="font-bold text-white">Hashtag:</span> {contacts.hashtag}
            </span>
          </div>
        </div>
